...
<body style="background-color:rgb(204, 204, 204)">
    <div class="wrap">
        <button class="button" style="margin-top:-35px; margin-left:1210px; background-image: url(https://www.zastavki.com/pictures/640x480/2015/Backgrounds_Orange_gradient_background_096901_29.jpg); color: rgb(255, 255, 255);" onclick="window.location.href='index.php'">Home</button>
    </div>
    <div id="rectangle1">
        <span class="dot"></span>
