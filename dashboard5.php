...
<body style="background-color:rgb(204, 204, 204)">
    ...
    <div id="rectangle2" >
        ...
        <button class="bn dobutton" onclick="window.location.href='dashboard3.php'">DO</button>
    ...
    <div id="rectangle3">
        <button class="bnn bodbutton" onclick="window.location.href='dashboard4.php'">BOD</button>
          <button class="bnn codbutton" style="background-image: url(https://www.zastavki.com/pictures/640x480/2015/Backgrounds_Orange_gradient_background_096901_29.jpg); color: rgb(255, 255, 255);">COD</button>
          <button class="bnn waterconbutton" onclick="window.location.href='dashboard2.php'">CONSUMPTION</button>
