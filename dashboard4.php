...
<body style="background-color:rgb(204, 204, 204)">
    ...
    <div id="rectangle3">
        <button class="bnn bodbutton" style="background-image: url(https://www.zastavki.com/pictures/640x480/2015/Backgrounds_Orange_gradient_background_096901_29.jpg); color: rgb(255, 255, 255);">BOD</button>
